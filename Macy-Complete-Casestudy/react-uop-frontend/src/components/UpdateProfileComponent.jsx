...
class UpdateProfileComponent extends Component {
    ...
    updateProfile = (p) => {
        ...
        ProfileService.updateProfile(profile, this.state.profileId).then(res => {
                                ...
                                <form>
                                    <div className="form-group">
                                        ...
                                        <input placeholder="ID" name="profileId" className="form-control"
                                            value={this.state.profileId} onChange={this.changeIdHandler} />
                                    </div>
                                    <div className="form-group">
                                        <label> Name: </label>
                                        <input placeholder="Name" name="profileName" className="form-control"
                                            value={this.state.profileName} onChange={this.changeProfileNameHandler} />
                                    </div>
                                    <div className="form-group">
                                        <label> Type: </label>
                                        <input placeholder="Type" name="profileType" className="form-control"
                                            value={this.state.profileType} onChange={this.changeProfileTypeHandler} />
                                    </div>
                                    <div className="form-group">
                                        <label> Criteria Name: </label>
                                        <input placeholder="Criteria Name" name="criteriaName" className="form-control"
                                            value={this.state.criteriaName} onChange={this.changeCriteriaNameHandler} />
                                    </div>
                                    <div className="form-group">
                                        <label> Criteria Value: </label>
                                        <input placeholder="Criteria Value" name="criteriaValue" className="form-control"
                                            value={this.state.criteriaValue} onChange={this.changeCriteriaTypeHandler} />
                                    </div>
                                    <div className="form-group">
                                        <label> Generate Shipment: </label>
                                        <input placeholder="Yes/No" name="generateShipment" className="form-control"
                                            value={this.state.generateShipment} onChange={this.changeGenerateShipmentHandler} />
                                    </div>
                                    <button className="btn btn-success" onClick={this.updateProfile}>Save</button>
